...
export const vi: Record<string, string> = {
  ...
  "model.codex-warning": "Chưa kết nối ChatGPT/Codex - cài Codex CLI và chạy `codex login`, hoặc thêm OPENAI_API_KEY dự phòng ở trang Kết nối.",
  "model.codex-warning-short": "Chạy `codex login` hoặc thêm OPENAI_API_KEY dự phòng.",
  "model.codex-not-connected": "Chưa kết nối Codex",
  "model.model": "Model",
  "model.effort": "Chế độ",
  "model.gemini-tooltip": "Gemini dùng để tạo ảnh và video Omni",
  "model.gemini-connected": "Gemini đã kết nối - sẵn sàng tạo ảnh và video Omni.",
  "model.gemini-not-connected": "Gemini chưa kết nối - đăng nhập Antigravity Subscription hoặc thêm API key dự phòng.",
  "model.gemini-images-only": "Gemini: chỉ Tạo ảnh",
  "model.gemini-media-only": "Gemini: ảnh + video Omni",
  "model.cost-tip":
  ...
  "project.ai-current": "AI đang sử dụng",
  "project.ai-mode": "Chế độ: {mode}",
  "project.ai-model-default": "Model mặc định của phiên cũ",
  "project.ai-mode-default": "Mặc định",
  ...
  "brief.notes-placeholder": "vd: Edit TikTok chuyên nghiệp - chữ động nhấn ý chính, phụ đề karaoke, chèn b-roll khi nhắc tới sản phẩm…",
  ...
  "brief.illustrations-hint": "AI tự chọn ý chính, Antigravity Subscription vẽ minh họa đồng bộ Style Design; API key chỉ dùng dự phòng.",
  ...
  "brief.gemini-warning": "Cần Antigravity CLI đã đăng nhập hoặc GEMINI_API_KEY dự phòng (trang Kết nối).",
  ...
  "imageDetail.gemini-tooltip": "Chưa kết nối Gemini - đăng nhập Antigravity CLI, thêm API key dự phòng ở trang Kết nối, hoặc tải nền lên.",
  ...
  "imageDetail.gemini-hint": "Gemini chưa kết nối - đăng nhập Antigravity Subscription hoặc thêm GEMINI_API_KEY dự phòng; cũng có thể tải nền lên thủ công.",
  ...
  "stylesPage.name-placeholder": "vd: AIEV dark fintech",
  ...
  "prompts.name-placeholder": "vd: TikTok chuyên nghiệp, sound nhẹ nhàng",
  ...
  "conn.role.video": "Tạo video AI",
  "conn.role.stt": "Bóc lời",
