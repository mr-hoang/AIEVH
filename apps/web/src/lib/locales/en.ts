...
export const en: Record<string, string> = {
  ...
  "model.gemini-not-connected": "Gemini not connected - sign in to Antigravity Subscription or add a fallback API key.",
  ...
  "project.ai-current": "AI in use",
  "project.ai-mode": "Mode: {mode}",
  "project.ai-model-default": "Legacy session default model",
  "project.ai-mode-default": "Default",
  ...
  "brief.illustrations-hint": "AI picks the key moments; Antigravity Subscription creates Style Design illustrations, with the API key used only as fallback.",
  ...
  "brief.gemini-warning": "A signed-in Antigravity CLI or fallback GEMINI_API_KEY is required (Connections page).",
  ...
  "imageDetail.gemini-tooltip": "Gemini not connected - sign in to Antigravity CLI, add a fallback key on Connections, or upload a background.",
  ...
  "imageDetail.gemini-hint": "Gemini is not connected - sign in to Antigravity Subscription or add a fallback GEMINI_API_KEY; you can also upload a background manually.",
  ...
  "doctor.label.gemini": "Antigravity / Gemini",
